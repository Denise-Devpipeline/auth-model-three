...
class Users(db.Model):
    ...
    def __init__(self, first_name, last_name, email, password, phone, city, state, orig_id, active):
...
class UsersSchema(ma.Schema):
    ...
    organizaiton = ma.fields.Nested(OrganizationsSchema())


user_schema = UsersSchema()
users_schema = UsersSchema(ma=True)
